...
public class ImageCodeGenerator implements ValidationCodeGenerator {

    @Autowired
    private SecurityProperties securityProperties;

    @Override
    public ImageCode generateValidationCode(ServletWebRequest request) {
        ...
        return new ImageCode(sRand, securityProperties.getCode().getImage().getExpiredIn(), image);
    }
